<?php
	...
	while($Isi=_mysql_fetch_array($Qry)){
		...
		$Script.="
			$.ajax({
				type: 'POST', url: 'etl.inc.php?id_maping={$Isi['id_maping']}', dataType:'json',
	...
	<table width='100%'>
	<tr>
		<td width='40%' valign=top>{$List}</td>
		<td width='60%' valign=top>{$Info}</td>
	</tr>
	</table>
