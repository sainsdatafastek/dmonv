<?php
	...
	$Qry="select id_dbname, dbname from reg_db_dwh";
	...
	$List="
		".$Func->tabSplit("List Databases Datawarehouse")."
		<p align=right>
		...
		<tr>
			...
			<th>".$Func->SortHeader("Nama Database Datawarehouse")."</th>
	...
	if(!empty($dbname)){
			/// TABLES
		///// PARAMETER AND QUERY GRID
		$Qry="select id_table,table_name from reg_db_dwh_table where dbname='{$dbname}'";
