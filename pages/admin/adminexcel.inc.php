...
else
{
	...
	{				
		...
		case "":default:
			...
			$QLinkAdm=_mysql_query("select link_sub from __v_menu where username='$sUserId' and link_sub='$url'");
			...
			else
			{
				...
				Selamat datang di halaman member aplikasi inventory. Silahkan klik menu pilihan yang berada di bagian atas untuk mengelola data. <br>
