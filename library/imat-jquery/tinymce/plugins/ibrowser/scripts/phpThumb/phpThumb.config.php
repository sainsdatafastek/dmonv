...
// If so, modify the $PHPTHUMB_CONFIG['_mysql_query'] line to suit your database structure
...
$PHPTHUMB_CONFIG['_mysql_query'] = '';
//$PHPTHUMB_CONFIG['_mysql_query'] = 'SELECT `picture` FROM `products` WHERE (`id` = \''.mysql_escape_string(@$_GET['id']).'\')';

// These 4 values must be modified if $PHPTHUMB_CONFIG['_mysql_query'] is not empty, but may be ignored if $PHPTHUMB_CONFIG['_mysql_query'] is blank.
