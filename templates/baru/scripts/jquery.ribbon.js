...
(function($) {
    ...
    $.fn.Ribbon = function(ribbonSettings) {
        ...
        $('head').append('<link href="./templates/baru/ribbon/themes/' + settings.theme + '/ribbon.css" rel="stylesheet" type="text/css" />" />');
        ...
        if (isLoaded) {
            ...
            $('.ribbon-list div img[src*="./templates/baru/images/arrow_down.png"]').remove();
        }

        $('.orb li:first ul:first').prepend('<img src="./templates/baru/ribbon/themes/' + settings.theme + '/images/menu_top.png" style="margin-left: -10px; margin-top: -22px;" />');
        $('.orb li:first ul:first').append('<img src="./templates/baru/ribbon/themes/' + settings.theme + '/images/menu_bottom.png" style="margin-left: -10px; margin-bottom: -22px;" />');

        $('.ribbon-list div').each(function() { if ($(this).children('ul').length > 0) { $(this).append('<img src="./templates/baru/ribbon/themes/' + settings.theme + '/images/arrow_down.png" style="float: right; margin-top: 5px;" />') } });
