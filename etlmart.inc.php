<?php
	...
	$TmpQry="select b.dbname as dbmart, c.dbname as dbsumber, c.hostname as hsumber, c.username as usumber, c.`password` as psumber, d.query_script, d.query_name ,e.table_name from reg_maping_dwh_to_mart as a inner join reg_db_mart as b on a.id_dbname_dwh=b.id_dbname inner join reg_db_sumber as c on a.id_dbname_sumber=c.id_dbname inner join reg_db_sumber_query as d on a.id_query=d.id_query inner join reg_db_mart_table as e on a.id_table=e.id_table WHERE a.id_maping='{$id_maping}'";
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////
	/// DATA DWH
	$con02 = mysqli_connect($Master_Host, $Master_User, $Master_Pwd, $MIsi['dbmart']);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$QInsertValue="";
	$QParam="";
	$Qry02 = mysqli_query($con00,"select field_sumber, field_dwh, param from reg_maping_dwh_to_mart_field where id_maping='{$id_maping}'");
	if(mysqli_num_rows($Qry02)>0){
		...
		///////////////////////////////////////////////////////////////////////////////////////////////////////////
		 ...
		 $response->result = "Berhasil, ".$MIsi['dbsumber'].".".$MIsi['query_name']." Ke Mart ".$MIsi['dbmart'].".".$MIsi['table_name']." Record[".($i-1)."]";
		 $response->status="1";
	}else{
		$response->status="2";
		$response->result = "Gagal, ".$MIsi['dbsumber'].".".$MIsi['query_name']." Ke DWH ".$MIsi['dbmart'].".".$MIsi['table_name'];
	}
	/*
    mysqli_close($con00);
	mysqli_close($con01); 
